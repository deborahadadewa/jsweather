      ...
      forecastHTML += `
            <div class="col">
                <div class="forecast-day" id="forecast-day">
                    ...
                    <img class="forecast-icon" src="https://openweathermap.org/img/wn/${forecastDay.weather[0].icon
...
function displayError(errorMessageHTML, errorNote) {
  ...
  if (errorType === "general") {
    errorImage.innerHTML = `<img src="media/citynotfound.png" alt="storm" />
`;
...
function searchCity(city) {
  ...
  if (city) {
    ...
    axios.get(apiUrlCity).then(displayWeather, (error) => {
      displayError(
        `<p>We can't find a city named <span>"${city}"</span>.<br />
